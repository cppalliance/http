...
#ifndef BOOST_HTTP_IO_ANY_WRITE_SINK_HPP
#define BOOST_HTTP_IO_ANY_WRITE_SINK_HPP
...
/** Type-erased wrapper for any WriteSink.
    ...
    capy::const_buffer buf(data, size);
...
public:
    ...
    */
    ...
    /** Initiate a complete write operation.
        ...
        windowed through @ref capy::buffer_param when the sequence exceeds
...
any_write_sink::write_some(CB buffers)
{
    ...
    {
        any_write_sink* self_;
        capy::detail::const_buffer_array<capy::detail::max_iovec_> ba_;
