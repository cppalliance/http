...
#ifndef BOOST_HTTP_IO_ANY_READ_SOURCE_HPP
#define BOOST_HTTP_IO_ANY_READ_SOURCE_HPP
...
public:
    ...
    */
    ...
    /** Initiate a complete read operation.
        ...
        @li **Success**: `!ec` and `n == capy::buffer_size(buffers)`.
...
any_read_source::read_some(MB buffers)
{
    struct awaitable
    {
        ...
        capy::detail::mutable_buffer_array<capy::detail::max_iovec_> ba_;
...
inline auto
any_read_source::read_(std::span<capy::mutable_buffer const> buffers)
{
    struct awaitable
    {
        any_read_source* self_;
