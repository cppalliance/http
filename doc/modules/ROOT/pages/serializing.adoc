...
install_serializer_service(cfg);
...
Serializer behavior is controlled through configuration installed globally:
...
cfg.max_type_erase = 1024;           // Space for buffer sequence storage
