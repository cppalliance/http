...
write the interfacing network implementation on top of HTTP.

The companion library Boost.HTTP.IO uses Boost.HTTP to implement network
...
Boost.HTTP is tested with the following compiler versions:
